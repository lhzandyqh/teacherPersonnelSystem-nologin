<template>
    <div class="app-container">
      <div class="content">
        <div id="zhuguan" style="width:100%;height: 400px" />
      </div>
    </div>
</template>
...
<script>
  ...
  require('echarts/theme/macarons') // echarts theme
    export default {
      ...
      methods: {
        initChart: function() {
          this.chart = echarts.init(document.getElementById('zhuguan'), 'macarons')
        ...
        chartRes() {
          let _this = this;
          window.addEventListener('resize', function () {
            let w = document.getElementById("zhuguan").offsetWidth
            let h = document.getElementById("zhuguan").offsetHeight
            let resize = {
              width: w,
              height: h
            }
