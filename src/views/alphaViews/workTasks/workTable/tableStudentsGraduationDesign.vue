<template>
  <div class="app-container">
    ...
    <el-table :data="matchData" style="width: 100%" stripe>
      <el-table-column prop="academicname" label="学生毕业设计题目" >
      </el-table-column>
      <el-table-column prop="academicform" label="学生姓名">
      </el-table-column>
      <el-table-column prop="academictime" label="学生专业" >
      </el-table-column>
      <el-table-column prop="academictime" label="学生学号" >
      </el-table-column>
      <el-table-column prop="academicplace" label="开始时间" >
      </el-table-column>
      <el-table-column prop="academicplace" label="结束时间" >
      </el-table-column>
