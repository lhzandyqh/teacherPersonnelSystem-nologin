<template>
  <div class="app-container">
    ...
    <el-table :data="matchData" style="width: 100%" stripe>
      <el-table-column prop="academicname" label="单位名称" >
      </el-table-column>
      <el-table-column prop="academicform" label="实践内容">
      </el-table-column>
      <el-table-column prop="academicform" label="到款额">
      </el-table-column>
      <el-table-column prop="academictime" label="实践开始时间" >
      </el-table-column>
      <el-table-column prop="academictime" label="实践结束时间" >
      </el-table-column>
